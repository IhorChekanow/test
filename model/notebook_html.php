...
=======
<h3 class="products_type">Ноутбуки</h3>
<ul class="products_list">
	<li class="product">
		<div class="product_view">
			<img src="products/comp/comp_black.jpg" alt="">
		</div>
		<div class="product_text">
			<div class="product_name">
			...
			<div class="product_description">
				...
				<p class="description">Doloremque dicta ipsum culpa adipisci!</p>
			</div>
			<div class="product_price">
			<span class="product_title">Цена:</span>
			<span class="price">1605</span>
			</div>
		</div>
	</li>
	<li class="product">
		<div class="product_view">
			<img src="products/comp/comp_red.jpg" alt="">
		</div>
		<div class="product_text">
			<div class="product_name">
				<h4 class="name">Samsung grand 2</h4>
	...
	<li class="product">
		<div class="product_view">
			<img src="products/comp/comp_silver.jpg" alt="">
		</div>
		<div class="product_text">
			<div class="product_name">
				<h4 class="name">Samsung grand 2</h4>
	...
	<li class="product">
		<div class="product_view">
			<img src="products/comp/comp_white.jpg" alt="">
		</div>
		<div class="product_text">
			<div class="product_name">
				<h4 class="name">Samsung grand 2</h4>
...
>>>>>>> recover-branch:model/notebook_html.php
